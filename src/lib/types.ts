...
export const ZONE_PROFILES: ZoneProfile[] = [
  {
    ...
    designTraits: [
      'חומריות: עץ טבעי, מתכת מושחרת',
      'צבעוניות: גווני חול, אפור-כחלחל',
      'סגנון: מינימליסטי-ימי',
      'גימור: חלק, עמיד בתנאי מזג אוויר ימי',
      'תאורה: חמה ומוסתרת',
      'ריהוט: אינטגרלי בלבד, ללא כיסאות נפרדים',
    ],
    rules: [
  ...
  },
  {
    ...
    designTraits: [
      'חומריות: מתכת ועץ ימי מעובד',
      'צבעוניות: כחול-לבן, אפור פלדה',
      'סגנון: נמלי-מודרני',
      'גימור: צבע אפוי עמיד בלחות',
      'תאורה: תעשייתית-חמה',
      'ריהוט: ספסלי בר בסגנון ימי',
    ],
    rules: [
      { category: 'עמדת מזון ניידת (פודטראק)', allowed: true },
      { category: 'דלפק-בר אינטגרלי', allowed: true },
  ...
  },
  {
    ...
    designTraits: [
      'חומריות: עץ בהיר, אלומיניום',
      'צבעוניות: לבן-חולי, תכלת',
      'סגנון: חופי-קליל',
      'גימור: עמיד בחול ומלח',
      'תאורה: טבעית, ללא תוספת חיצונית',
      'ריהוט: אינטגרלי בלבד',
    ],
    rules: [
      { category: 'עמדת מזון ניידת (פודטראק)', allowed: true },
  ...
  },
  {
    ...
    designTraits: [
      'חומריות: עץ טבעי, אבן מקומית',
      'צבעוניות: ירוק-חאקי, חום אדמה',
      'סגנון: אורגני-טבעי',
      'גימור: מרקם טבעי, ללא ברק',
      'תאורה: חמה ומוסתרת בנוף',
      'ריהוט: אינטגרלי, משתלב בצמחייה',
    ],
    rules: [
      { category: 'עמדת מזון ניידת (פודטראק)', allowed: true },
      { category: 'דלפק-בר אינטגרלי', allowed: true },
  ...
  },
  {
    ...
    designTraits: [
      'חומריות: עץ ומתכת כהה',
      'צבעוניות: אפור-ירוק, חום כהה',
      'סגנון: נופי-אקולוגי',
      'גימור: עמיד בלחות ושמש',
      'תאורה: רכה, שומרת על חיי לילה טבעיים',
      'ריהוט: אינטגרלי, מינימלי',
    ],
    rules: [
      { category: 'עמדת מזון ניידת (פודטראק)', allowed: true },
      { category: 'דלפק-בר אינטגרלי', allowed: true },
  ...
  },
  {
    ...
    designTraits: [
      'חומריות: אבן טבעית, מתכת חלודה (Corten)',
      'צבעוניות: גווני אדמה, חלודה, בז\'',
      'סגנון: היסטורי-ארכאולוגי',
      'גימור: מרקם מחוספס, לא מבריק',
      'תאורה: חמה נמוכה, שומרת אופי עתיק',
      'ריהוט: אינטגרלי מאבן או מתכת',
    ],
    rules: [
      { category: 'עמדת מזון ניידת (פודטראק)', allowed: true },
      { category: 'דלפק-בר אינטגרלי', allowed: true },
